...
def game():
    ...
    box23=Button(div1,command=lambda :play(23),bg="#1c2127",image=logo2)
    box24=Button(div1,command=lambda :play(24),bg="#1c2127",image=logo2)
   # box25=Button(div1,command=lambda :play(25),bg="#1c2127",image=logo2)
   # box26=Button(div1,command=lambda :play(24),bg="#1c2127",image=logo2)
   # box27=Button(div1,command=lambda :play(24),bg="#1c2127",image=logo2)
  ...
  #  box20.place(x=484,y=342)
   ...
   # box23.place(x=958,y=342)
    ##box24.place(x=1116,y=342)
    #.place(x=1117,y=380)
   # box26.place(x=1118,y=400)
   # box27.place(x=1119,y=420)
