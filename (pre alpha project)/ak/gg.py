...
class bulllet():
    ...
    def __init__(self,bx,by,gx,gy,xxx,yyy):
        self.gx=gx
        self.gy=gy
        self.bx=bx
        self.by=by
      #  print('sss')
       # print('cls',gx,gy,bx,by)
    ...
    def move(self):
     #   global x_way,y_way
      ...
      #  shot=True
        ...
        bulls=pygame.draw.rect(win,'blue',(x_way[self.xxx],y_way[self.yyy],5,5))
...
while run:
    ...
    if event.type == pygame.MOUSEBUTTONDOWN:
        bll=bulllet(x,y,m[0],m[1],0,0)
        j=1
        
      #  print(shot,'a')
        #print(bll.gx,bll.gy,bll.bx,bll.by)
